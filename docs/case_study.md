...
- **Year-over-year:** Antonelli has gained between 0.3 and 0.7 s on Russell at all four tracks since his rookie year (**mean +0.53 s/track**). The rookie closing arc isn't just being sustained — it's being compressed.
...
- **Independent cross-check:** sector-time data (from the timing-line beam, not the car telemetry) confirms each lap-level delta, including a Japan lap where the car sensors were partially compromised.
