...
*Source: 2026 Canada Q.*

- Clean laps used: **RUS** 6, **ANT** 7.
- Fastest lap: RUS 72.578s, ANT 72.646s -> official gap **-0.068s** (= RUS slower).
- Cumulative-delta curve endpoint **-0.060s**, reconciles to within **0.0076s** (tolerance 0.05s).

**Ranked micro-sectors (top by magnitude):**

| rank | sector | mid (m) | delta mean (s) | 95% CI | real? |
|---:|---:|---:|---:|:--:|:--:|
| 1 | 7 | 1440 | +0.147 | [-0.054, +0.336] | noise |
| 2 | 6 | 1173 | -0.141 | [-0.220, -0.056] | yes |
| 3 | 13 | 3676 | +0.083 | [-0.054, +0.236] | noise |
| 4 | 11 | 2827 | +0.082 | [-0.021, +0.185] | noise |
| 5 | 8 | 1827 | -0.064 | [-0.135, -0.003] | yes |
| 6 | 1 | 138 | +0.046 | [-0.079, +0.162] | noise |
| 7 | 14 | 4091 | +0.027 | [-0.147, +0.166] | noise |
| 8 | 9 | 2186 | +0.027 | [-0.073, +0.127] | noise |

**Attribution at the key (real) micro-sectors:**

- Sector 6 (1101-1245 m): 0.141 s to RUS [real (CI excludes 0)]. ANT brakes ~4 m later than RUS (entry).
- Sector 8 (1636-2019 m): 0.064 s to RUS [real (CI excludes 0)]. RUS brakes ~34 m later than ANT (entry); RUS carries ~3 km/h more apex speed (mid-corner).

> **Noise check.** Sector 7 shows a +0.147s 'edge', but its 95% CI [-0.054, +0.336] straddles zero - this is not a real advantage, just a good/bad lap.
